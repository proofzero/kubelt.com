...
export default function Header() {
  return (
    <Popover className="absolute sm:px-12 md:px-12 lg:px-24 w-screen z-50">
      {({ open }) => (
        <>
          <div className="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10 max-w-7xl mx-auto">
            <div>
              <a href="/" className="">
                <span className="sr-only">kubelt</span>
                <LogoIcon className="h-10 w-auto sm::h-10" />
              </a>
            </div>
                    ...
                    <>
                      <Popover.Button
                        className={classNames(
                          ...
                          'group rounded-md inline-flex items-center text-base font-medium hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                        )}
                      >
                        <span>Solutions</span>
                        <ChevronDownIcon
